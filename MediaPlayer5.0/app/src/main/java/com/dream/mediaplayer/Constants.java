...
public final class Constants {
    ...
    public final static String MACHINE_MODE = "CLASSONE_C3L";
    public final static String MACHINE_MODE2 = "DSL C5";
    // SharedPreferences
    public final static String APOLLO = "iHappy", APOLLO_PREFERENCES = "apollopreferences",
            ...
            PLAYLIST_NAME_FAVORITES = "最喜爱的", PLAYLIST_NAME = "playlist", WIDGET_STYLE="widget_type",
    ...
    public final static String INTENT_ADD_TO_PLAYLIST = "com.dream.mediaplayer.ADD_TO_PLAYLIST",
            INTENT_PLAYLIST_LIST = "playlistlist",
            INTENT_CREATE_PLAYLIST = "com.dream.mediaplayer.CREATE_PLAYLIST",
            INTENT_RENAME_PLAYLIST = "com.dream.mediaplayer.RENAME_PLAYLIST",
    ...
    public final static String ADD_TO_PALYLIST = "addToPlaylist";
}
