...
public class AlbumOfTracksActivity extends Activity  implements ServiceConnection {
	
	private String tag = "AlbumOfTracksActivity --- ";
	...
	private RelativeLayout mRetrunBtn;
	
	private TextView mTextAlbumName;
	
	private ImageView mAlbumCover;
	
	private TextView mInfoAlbumName;
	
	private TextView mInfoArtistName;
	...
	protected void onCreate(Bundle savedInstanceState) {
        ...
        // Layout
        setContentView(R.layout.activity_album_of_tracks);
	...
	private void getElements() {
		...
		mRetrunBtn = (RelativeLayout) findViewById(R.id.topbar_return_content);
		mTextAlbumName = (TextView) findViewById(R.id.album_name);
		mAlbumCover = (ImageView) findViewById(R.id.album_cover_img);
		mInfoAlbumName = (TextView) findViewById(R.id.albumName);
		mInfoArtistName = (TextView) findViewById(R.id.artistName);
		mInfoTotalDuration = (TextView) findViewById(R.id.totalDuration);
    ...
    private void initAlbumInfo() {
        ...
        mTextAlbumName.setText(getAlbum());
        mInfoAlbumName.setText(getAlbum());
        mInfoArtistName.setText(getArtist());
        mInfoTotalDuration.setText("");
    }
