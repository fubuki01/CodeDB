package com.dream.mediaplayer.cache;
...
import com.dream.mediaplayer.helpers.GetBitmapTask.OnBitmapReadyListener;
...
public class ImageProvider implements GetBitmapTask.OnBitmapReadyListener{
    ...
    private void asyncLoad(String tag, ImageView imageView, AsyncTask<String, Integer, Bitmap> task) {
        ...
        if (pendingImages == null) {
            ...
            task.executeOnExecutor(/*Executors.newCachedThreadPool()*//*AsyncTask.THREAD_POOL_EXECUTOR*/AsyncTask.SERIAL_EXECUTOR);
        }
