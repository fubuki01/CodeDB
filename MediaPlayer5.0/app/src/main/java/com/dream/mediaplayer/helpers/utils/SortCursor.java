...
//        	return entry1.key.compareToIgnoreCase(entry2.key);
    ...
    public SortCursor(Cursor cursor,String columnName) {          
        ...
        mCursor = cursor;
        Log.e("onLoadFinished", "SortCursor: "+mCursor+"   "+mCursor.getCount());
...
//                Log.e("SortCursor", "SortCursor: "+pinyin+"    "+column+"   "+cursor.getString(column));
                String formatFirstname ="";
                if (pinyin.equals("")||pinyin==null){
                    formatFirstname="#";
                }else {
                    formatFirstname = pinyin.substring(0, 1);
                }
//                Log.e("onLoadFinished", "formatFirstname: "+formatFirstname);
