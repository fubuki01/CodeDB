 ...
 */
public class MediaAppWidgetProvider_4_2 extends AppWidgetProvider {
    ...
    private static MediaAppWidgetProvider_4_2 sInstance;

    private static boolean mPauseState = false;
    private static boolean mNoneedperformUpdate = false;

    public static synchronized MediaAppWidgetProvider_4_2 getInstance() {
        if (sInstance == null) {
            sInstance = new MediaAppWidgetProvider_4_2();
        }
        return sInstance;
    }
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (action.equals(UPDATE_WIDGET_ACTION) && hasInstances(context)) {
            ...
            final RemoteViews views = new RemoteViews(context.getPackageName(), R.layout.album_appwidget_4_2);
            AppWidgetManager appWidgetManager = AppWidgetManager.getInstance(context);
            int[] appWidgetIds = appWidgetManager.getAppWidgetIds(new ComponentName(context, this.getClass()));
            views.setImageViewResource(R.id.btn_play, R.drawable.widget_play_button_4_2_bg);
    ...
    public void onUpdate(Context context, AppWidgetManager appWidgetManager, int[] appWidgetIds) {
        ...
        updateIntent.putExtra(ApolloService.CMDNAME,
                MediaAppWidgetProvider_4_2.CMDAPPWIDGETUPDATE);
...
//        views.setViewVisibility(R.id.song_name, View.GONE);
    ...
    public void performUpdate(ApolloService service, int[] appWidgetIds) {
        ...
        final RemoteViews views = new RemoteViews(service.getPackageName(), R.layout.album_appwidget_4_2);
...
//            views.setViewVisibility(R.id.song_name, View.VISIBLE);
        ...
        if (playing) {
            views.setImageViewResource(R.id.btn_play, R.drawable.widget_play_button_pause_4_2_bg);
        } else {
...
//                views.setViewVisibility(R.id.song_name, View.GONE);
		...
		case ApolloService.SHUFFLE_NONE:
			views.setImageViewResource(R.id.btn_shuffle, R.drawable.widget_btn_play_shuffle_close_4_2_selector);
			break;
		case ApolloService.SHUFFLE_AUTO:
			views.setImageViewResource(R.id.btn_shuffle, R.drawable.widget_btn_play_shuffle_open_4_2_selector);
			break;
		default:
			views.setImageViewResource(R.id.btn_shuffle, R.drawable.widget_btn_play_shuffle_open_4_2_selector);
			break;
		...
		case ApolloService.REPEAT_ALL:
			views.setImageViewResource(R.id.btn_repeat, R.drawable.widget_btn_play_repeat_all_4_2_selector);
			break;
		case ApolloService.REPEAT_CURRENT:
			views.setImageViewResource(R.id.btn_repeat, R.drawable.widget_btn_play_repeat_single_4_2_selector);
			break;
		default:
			views.setImageViewResource(R.id.btn_repeat, R.drawable.widget_btn_play_repeat_close_4_2_selector);
			break;
		}
