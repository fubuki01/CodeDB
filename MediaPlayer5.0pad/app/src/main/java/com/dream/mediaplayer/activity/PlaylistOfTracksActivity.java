...
public class PlaylistOfTracksActivity extends Activity  implements ServiceConnection {
...
//    	mImageProvider = ImageProvider.getInstance( this );
        ...
        addFragment(new TracksFragment(bundle));
	}
...
//				MusicUtils.finishTranstion((Activity)mContext, false);
	...
	private void initAlbumInfo() {
        ...
        if (ApolloUtils.isArtist(mimeType)) {
            ...
            mTextAlbumName.setText(plyName);
        }
        else{ 
