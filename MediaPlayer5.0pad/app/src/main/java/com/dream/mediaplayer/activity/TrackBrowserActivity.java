...
//            }
        ...
        setContentView(R.layout.queue_fragment_layout);
...
//        setTitle();
        ...
        if ("nowplaying".equals(mPlaylist)) {
            try {
                ...
                mNowPlayingListener.onReceive(this, new Intent(ApolloService.META_CHANGED));
            ...
            mTrackListListener.onReceive(this, new Intent(ApolloService.META_CHANGED));
        }
    }
