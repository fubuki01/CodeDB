...
import static com.dream.mediaplayer.Constants.UP_STARTS_ALBUM_ACTIVITY;
...
import com.dream.mediaplayer.ui.adapters.AlbumAdapter;
...
public class AlbumsFragment extends Fragment implements
	...
	// Audio columns
	public static int mAlbumIdIndex, mAlbumNameIndex, mArtistNameIndex, mNumberOfSongsIndex;
	...
	public void onActivityCreated(Bundle savedInstanceState) {
		...
		mAlbumAdapter = new AlbumAdapter(getActivity(),
				R.layout.albums_gridview_item_layout, null, new String[] {}, new int[] {}, 0);
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		View root = inflater.inflate(R.layout.albums_fragment_layout, container, false);
	...
	public void onLoadFinished(Loader<Cursor> loader, Cursor data) {
		...
		//
		//mNumberOfSongsIndex = data.getColumnIndexOrThrow(AlbumColumns.NUMBER_OF_SONGS);
		try{
			mNumberOfSongsIndex = data.getColumnIndex(AlbumColumns.NUMBER_OF_SONGS);
		}catch (Exception e){
			e.printStackTrace();
			mNumberOfSongsIndex = 0;
		}
...
//				intent, 
//				Pair.create((View)v, "album_share"));
//		MusicUtils.screenTransitAnimByPair(getActivity(), 
//				intent, null);
	}
...
//		menu.add(0, PLAY_SELECTION, 0,
//				getResources().getString(R.string.play_all));
//		menu.add(0, ADD_TO_PLAYLIST, 0,
//				getResources().getString(R.string.add_to_playlist));
        
		MenuColorFix.addMenu(menu, 0, PLAY_SELECTION, 0,
				getResources().getString(R.string.play_all));
		MenuColorFix.addMenu(menu, 0, ADD_TO_PLAYLIST, 0,
				getResources().getString(R.string.add_to_playlist));
//		menu.add(0, SEARCH, 0, getResources().getString(R.string.search));

		mCurrentAlbumId = mCursor.getString(mCursor
...
//		headerText.setBackgroundColor(getResources().getColor(
