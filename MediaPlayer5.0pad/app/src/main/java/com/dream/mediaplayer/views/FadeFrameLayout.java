...
//	private FadeImageView albumImageView;
    ...
    public FadeFrameLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
        this.context = context;
    }

    public FadeFrameLayout(Context context, AttributeSet attrs, int defStyle) {
...
//    	}
    	...
    	lrcView.setVisibility(visibility);
    }
