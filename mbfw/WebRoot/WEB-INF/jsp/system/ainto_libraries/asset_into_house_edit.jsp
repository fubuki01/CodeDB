...
<body>
	<form action="asset/${msg }.do" name="asset_into_houseForm" id="asset_into_houseForm" method="post" enctype="multipart/form-data">
		<div id="zhongxin">
		<input type="hidden" name="asset_code" id="asset_code" value="${agm.asset_code }">
		...
		<table  id="table_report" class="table text-table table-striped table-bordered">
			...
			<tr>
				...
				<td><input type="text" name="asset_class" id="asset_class"  placeholder="资产类别" value="${agm.asset_class }" readonly="readonly"></td>
				 <!-- <td><label><a title="由系统自动生成">资产编码</a><b style="color: red">*</b></label></td>
				<td><input type="text" name="asset_code1" id="asset_code1"  placeholder="由系统生成，资产编码"  readonly="readonly"></td> -->
			</tr>
			<tr>
			...
			<tr>
				...
				<td>
					<input  type="text" class="span10 date-picker"  name="asset_purchase_time" id="asset_purchase_time"  data-date-format="yyyy-mm-dd" style="width:222px;" placeholder="入库日期" title="入库日期" readonly="readonly"/>
				</td> -->
			...
			<!-- <tr>
				...
				<td><label>设备状态<b style="color: red">*</b></label></td>
				<td ><input type="text" readonly="readonly" placeholder="闲置"></td>
			...
			<tr>
				...
				<td>
					<input type="file" name="asset_img" id="asset_img" placeholder="上传申请报告" style="width: 221px">
				</td> -->
