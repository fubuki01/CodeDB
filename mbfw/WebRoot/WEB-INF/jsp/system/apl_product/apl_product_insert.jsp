...
<body>
	<form action="product/${msg }.do" name="productForm" id="productForm" method="post">
		...
		<table  id="table_report" class="table text-table table-striped table-bordered">
			<tr>
				<td colspan="4"><h1 style="color:red;">产品添加</h1></td>
			</tr>
			<tr>
				...
				<td style="vertical-align:top;">
					...
					<c:forEach items="${providerFind}" var="pf" varStatus="vs">
						<option value="${pf.provider_code }:${pf.provider_name }"  >${pf.provider_name } - ${pf.provider_code }</option>  
					</c:forEach>
					</select>
				...
				<td><label>产品标记<b style="color: red">*</b></label></td>
					<td style="vertical-align:top;">
					<select class="chzn-select" name="product_flag"  id="product_flag" onchange="select_asset_class(this.value);" style="width: 218px;vertical-align: center"  data-placeholder="产品标记" >
						<option ></option>
						<option value="固定资产" >固定资产</option>  
						<option value="耗材资产"  >耗材资产</option>
					</select>
				</td> 
			</tr>
			...
			<tr>
				...
				<td style="vertical-align: top;">
					<select class="chzn-select" data-placeholder="产品类别"name="product_class" id="product_class" onchange="select_product_class_name();">
					<option></option>
					</select>
				</td>
				<td><label>产品名称<b style="color: red">*</b></label></td>
				<td style="vertical-align: top;">
					<select class="chzn-select" name="select_product" id="select_product" <c:if test="${onlyedit == 'onlyedit'}">readonly</c:if> data-placeholder="请选择产品名称"style="width: 221px; vertical-align: center;">
						<option></option>						
					</select>
				</td>
			</tr>
			<tr>
				...
				<td><input type="text" name="product_price" id="product_price"  value="${pd.product_price }"   placeholder="产品价格"></td>
				<td><label>计量单位<b style="color: red">*</b></label></td>
				<td><input type="text" name="product_unit" id="product_unit"   value="${pd.product_unit }"  placeholder="计量单位"></td>
			</tr>
			<tr>
				<td><label>产品型号</label></td>
				<td>
					 <input type="text" name="product_type" id="product_type"   value="${pd.product_type }" placeholder="产品型号">
				</td> 
