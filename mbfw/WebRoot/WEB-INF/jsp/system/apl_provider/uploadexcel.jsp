...
<html lang="en">
	<head>
		...
		<script type="text/javascript">
			...
			//保存
			function save(){
				if($("#excel").val()=="" || document.getElementById("excel").files[0] =='请选择xls/xlsx格式的文件'){
...
<body>
	<form action="provider/readExcel.do" name="Form" id="Form" method="post" enctype="multipart/form-data">
		<div id="zhongxin">
		<table style="width:95%;" >
			...
			<tr>
				<td style="text-align: center;">
					...
					<a style="float: right;"  class="btn btn-mini btn-success" onclick="window.location.href='<%=basePath%>/provider/downAssetExcel.do'">下载模版</a>					
				</td>
			</tr>
		</table>
		</div>
