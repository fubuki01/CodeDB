	...
	<form action="asset/${msg }.do" name="asset_issuedForm" id="asset_issuedForm" method="post" enctype="multipart/form-data">
		...
		<table  id="table_report" class="table text-table table-striped table-bordered table-hover">
			...
			<tr>
				...
				<td><input type="text" name="asset_code" id="asset_code" value="${asset_code }" readonly placeholder="资产编码" ></td>
			...
			<tr>
				...
				<td style="vertical-align: top;">
				<select class="chzn-select" data-placeholder="下发部门" name="issued_department" id="issued_department" >
					<option></option>
				</select>
				</td>
			</tr>
			...
			<tr>
			 ...
			 <tr style="height: 40">
				<td style="text-align: center;" colspan="6">
				  ...
				  <a class="btn btn-mini btn-danger" onclick="issued_close();">取消</a>
				</td>
			</tr>
		</table>
		</div>
