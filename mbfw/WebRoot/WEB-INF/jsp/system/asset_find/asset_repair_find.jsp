			...
			<table>
				<tr>
					...
					<td style="vertical-align:top;"> 
					 	<select class="chzn-select" name="ASSERT_DATA__ID" id="assert_data_id" data-placeholder="资产种类" style="vertical-align:top;width: 120px;">
						<option value=""></option>
					...
					<!-- 资产使用状态 -->
					<td style="vertical-align:top;"> 
					 	<select class="chzn-select" name="ASSERT_USE_ID" id="assert_use_id" data-placeholder="资产使用状态" style="vertical-align:top;width: 120px;">
						<option value=""></option>
						<option value="">全部</option>
						<%-- <c:forEach items="${roleList}" var="role">
							<option value="${role.ROLE_ID }" <c:if test="${pd.ROLE_ID==role.ROLE_ID}">selected</c:if>>${role.ROLE_NAME }</option>
					...
					<!-- 维修状态 -->
					<td style="vertical-align:top;"> 
					 	<select class="chzn-select" name="ASSERT_REPAIR_ID" id="assert_repair_id" data-placeholder="维修状态" style="vertical-align:top;width: 120px;">
						<option value=""></option>
						<option value="">全部</option>
						<%-- <c:forEach items="${roleList}" var="role">
							<option value="${role.ROLE_ID }" <c:if test="${pd.ROLE_ID==role.ROLE_ID}">selected</c:if>>${role.ROLE_NAME }</option>
						</c:forEach> --%>
						<option value="">维修状态A</option>
						<option value="">维修状态S</option>
						<option value="">维修状态D</option>
					  	</select>
					</td>	
					...
					<c:when test="${not empty asset_datahouse}">
						...
						<c:forEach items="${asset_datahouse}" var="assetm" varStatus="vs">
								<tr>
									...
									<td>${assetm.asset_repair_status}</td>
