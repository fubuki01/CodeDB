...
<body>
	<form action="asset/arda_readExcel.do" name="Form" id="Form" method="post" enctype="multipart/form-data">
		<div id="zhongxin">
		<table style="width:95%;" >
			...
			<tr>
				<td style="text-align: center;">
					...
					<a style="float: right;"  class="btn btn-mini btn-success" onclick="window.location.href='<%=basePath%>/asset/arda_downAssetExcel.do'">下载模版</a>					
				</td>
			</tr>
		</table>
		</div>
