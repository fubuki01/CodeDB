		...
		$(document).ready(function() {
			...
			$.fn.zTree.init(treeObj, setting, zNodes);
					...
					function addChilePoint() {
						...
						var pName = $('#name').val();
						var url = '<%=basePath%>/asset/addMertialChildPoint.do?pId='+value+'&name='+pName;
					...
					function delect_piont() {
						...
						var url = '<%=basePath%>/asset/delectMertialPoint.do?number='+value+'&names='+encodeURI(encodeURI(names))+'&parent='+parent;
						$("#applyForm").attr("action",url).submit();
					}
...
<body>
					...
					<div class="col-md-12">
						<div class="box box-primary">
							<div class="box-header">
								...
								<div class="h3">
									<form action="asset/addMertialPoint.do" method="post"
										name="applyForm" id="applyForm">

										<c:if test="${QX.add == 1 }">
										<input type="text" id="name" name="name"
											style="height: 100%; margin-top: 8px;" placeholder="类别名称">
										...
										<a class="help-link" id="helptooltip" data-toggle="tooltip"
											...
											class="fa fa-info-circle" style="margin-right: 6px;"></i>如何设置耗材类别</a>
										</c:if>
									</form>
								</div>
							</div>
	...
	<script type="text/javascript">
		...
		function fromExcel(){
			 ...
			 diag.URL = '<%=basePath%>/asset/uploadMertialClassExcel.do';
			 diag.Width = 300;
			 diag.Height = 150;
