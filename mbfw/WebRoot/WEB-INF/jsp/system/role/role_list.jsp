  ...
  <div class="row-fluid">
	...
	<div id="breadcrumbs">
		<table class="center" style="width:100%;">
			<tr height="35">
				<c:if test="${QX.add == 1 }">
				<td style="width:100px;"><a href="javascript:addRole();" class="btn btn-small btn-success">新增权限组</a></td>
				</c:if>
					<c:choose>
	...
	<table id="table_report" class="table table-striped table-bordered table-hover">
		...
		<c:choose>
			<c:when test="${not empty roleList_z}">
				...
				<a class='btn btn-mini btn-info' title="编辑" onclick="editRole('${var.ROLE_ID }');"><i class='icon-edit'>编辑</i></a>
				</c:if>
				<c:choose> 
					...
					<c:otherwise>
					 <c:if test="${QX.del == 1 }">
					 <a class='btn btn-mini btn-danger' title="删除" onclick="delRole('${var.ROLE_ID }','c','${var.ROLE_NAME }');"><i class='icon-trash'>删除</i></a>
					 </c:if>
					</c:otherwise>
				</c:choose>
				</tr>
		...
		<table style="width:100%;">
			<tr>
				<td style="vertical-align:top;"><a class="btn btn-small btn-success" onclick="addRole2('${pd.ROLE_ID }');">新增角色权限</a></td>
			</tr>
		</table>
		</c:if>
		</div>
