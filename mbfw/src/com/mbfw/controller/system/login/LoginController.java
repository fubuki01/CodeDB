			...
			if (null == code || "".equals(code)) {
				...
				if ((Tools.notEmpty(sessionCode) && sessionCode.equalsIgnoreCase(code)) || ismobile) {
					...
					if (pd != null) {
						...
						user.setCreatuser_Time(pd.getString("creatuser_Time"));
						...
						map.put("superior_organization_name", user.getSuperior_organization_name());
						map.put("user_permission", ""+user.getUser_Permission());
...
/*	@RequestMapping(value = "/default")
	public String skipPage(@RequestParam(value = "aValue", required = true) String aValue) {
		switch(aValue){
			case "11":
				return "redirect:asset/asystem_showapprover";
			case "12":
				return "redirect:asset/asystem_showallnode";
			case "13":
				return "redirect:asset/asystem_showapprovalprocess";
			case "14":
				return "redirect:role";
			case "15":
				return "redirect:user/listUsers";
			case "16":
				return "redirect:asset/asystem_institutionalinfoshow";
			case "21":
				return "redirect:provider/apl_provider_manager";
			case "22":
				return "redirect:product/apl_product_index";
			case "31":
				return "redirect:asset/atp_showForm";
			case "32":
				return "redirect:asset/atp_approvalprojectlist";
			case "41":
				return "redirect:asset/setClass";
			case "42":
				return "redirect:asset/setMertialClass";
			case "51":
				return "redirect:asset/afc_assetFind";
			case "52":
				return "redirect:asset/asset_count_table.do?type=bm";
			case "53":
				return "redirect:asset/check_list";
			case "61":
				return "redirect:asset/arda_assertRegister";
			case "62":
				return "redirect:asset/arda_assertIssued";
			case "63":
				return "redirect:asset/arda_assertReceived";
			case "71":
				return "redirect:asset/aucs_manage";
			case "72":
				return "redirect:asset/aucs_recycle";
			case "73":
				return "redirect:asset/aucs_abandon";
			case "81":
				return "redirect:asset/acm_supply";
			case "82":
				return "redirect:asset/acm_use";
			case "83":
				return "redirect:asset/acm_inquiry";
			case "84":
				return "redirect:asset/acm_apply";
			case "91":
				return "redirect:asset/apl_Caigou_apply";
			case "92":
				return "redirect:asset/apl_ruku_apply";
			case "93":
				return "redirect:asset/arda_add_asset_index";
