package com.mbfw.controller.weixin;
...
import com.mbfw.service.weixin.command.CommandService;
import com.mbfw.service.weixin.imgmsg.ImgmsgService;
import com.mbfw.service.weixin.textmsg.TextmsgService;
...
/**
 * 类名称：WeixinController.java 微信公共平台开发
 * 
 * @author 研发中心 作者单位： 创建时间：2014年7月10日
 * @version 1.0
 */
@Controller
...
public class WeixinController extends BaseController {
	...
	public void getGz(PrintWriter out) {
		...
		try {
			...
			/*
			 * PrintWriter pw; try { pw = new PrintWriter( new FileWriter( "e:/gz.txt" ) ); pw.print(jsonObject.getString("total")); pw.close(); } catch (IOException e) { // TODO Auto-generated catch block e.printStackTrace(); }
