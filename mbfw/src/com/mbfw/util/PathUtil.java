...
public class PathUtil {
	...
	/**
	 * @param type "0"放在uploadFiles/file下
	 *  “1”放在asset_code_img文件夹
	 *  “2”放在asset_img文件夹
	 * @return 存放地址
	 */
	public static String getPath(String type) {
		String tomcat = System.getProperty("catalina.home");
		String path = tomcat+File.separator+"uploadFiles"+File.separator+"file";
		String path_img=tomcat+File.separator+"uploadFiles";// 资产图片和二维码保存路径
		
		if(type.equals("0")){
			
		}else if(type.equals("1")){
			path = path_img+File.separator+"asset_code_img";
		}else if(type.equals("2")){
			path = path_img+File.separator+"asset_img";
		}
