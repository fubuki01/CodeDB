...
public class ProviderInfoExcelRead {
	 ...
	 * @return list
	 */
	public static List<Object> providerInfoReadExcel(String filepath, String filename, int startrow, int startcol, int sheetnum) {
				...
				for(int j=startcol;j<=cellNum; j++){
					...
					if(i== 2){//判断导入的Excl表格是否符合规范格式(只需要判断第二行即可)
						if(j==0 && !"编号".equals(cellValue)){
							return null;
						}else if(j==1 && !"供应商名称".equals(cellValue)){
							return null;
						}
						else if(j==2 && !"供应商地址".equals(cellValue)){
							return null;
						}
						else if(j==3 && !"联系电话".equals(cellValue)){
							return null;
						}
						else if(j==4 && !"传真".equals(cellValue)){
							return null;
						}
						else if(j==5 && !"邮箱".equals(cellValue)){
							return null;
						}
						else if(j==6 && !"负责人或联系人姓名".equals(cellValue)){
							return null;
						}
						else if(j==7 && !"联系人电话".equals(cellValue)){
							return null;
						}
						else if(j==8 && !"产品质量标准".equals(cellValue)){
							return null;
						}
						else if(j==9 && !"供应商资质".equals(cellValue)){
							return null;
						}
						else if(j==10 && !"评价".equals(cellValue)){
							return null;
						}else if(j==11 && !"备注".equals(cellValue)){
							return null;
						}
