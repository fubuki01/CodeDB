...
public  abstract class GameActivityFenToXiao extends BaseGameActivity{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.game_view_fen_xiao);
		findView();//获取游戏界面
		initView();
		CountTimeThread();
	 ...
	 */
	@Override
	public  int judgeHandPut(String word, int ncout, short[] polongArray) {
		return 0;
	}
	@Override
