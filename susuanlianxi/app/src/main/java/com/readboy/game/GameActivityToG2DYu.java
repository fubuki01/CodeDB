...
public  abstract class GameActivityToG2DYu extends BaseGameActivity{

	private boolean correct1=false,correct2=false;
	@Override
	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.game_view_yu);
		findView();//获取游戏界面
		initView();
		CountTimeThread();
		...
		if((err == 0)||(err2==0)){
			...
			if((err <= 0)||(err2<=0)){
				...
				String answerStr2;
					...
					answerStr = String.valueOf((answer/10));
					answerStr2 = String.valueOf((answer%10));
