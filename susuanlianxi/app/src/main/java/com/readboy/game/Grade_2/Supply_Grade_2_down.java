...
//	  final private int MULANDDIV=1;  //乘除混合运算
//	  final private int MOD=2;	//有余数的除法
//	  final private int SIXDIV=3;    	//用6、7、8、9的乘法口诀求商
//	  final private int TWODIV=4;		//用2、3、4、5的乘法口诀求商
	...
	public void run() {
		...
		while(!stopThread){
			...
			Bundle bundle=new Bundle();
				...
				Log.e("4444444444444444", answer.get(count)+"");
...
//				bundle.putString("problem",problem.get(count));
//				bundle.putInt("answer", answer.get(count));
//				bundle.putInt("answer1", answer.get(count));
//				Log.e("4444444444444444", answer.get(count)+"");
//				Log.e("3333333333333333", answer.get(count)+"");
//				message.setData(bundle);
//				handler_program.sendMessage(message);
//				count++;
//			}
