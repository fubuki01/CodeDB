...
//				while ((ele_one*ele_two+10)%ele_two==0){
//					ele_two=ele_two-1;
//				}
//				problem.add((ele_one*ele_two+10)+"÷"+ele_two+"=");
//				int wyd11 = (int) (ele_one*ele_two+10)/ele_two;
//				int wyd22 = (ele_one*ele_two+10)%ele_two;
//				answer.add(wyd11*10+wyd22);
...
//				int wyd1 = (int) (ele_three*ele_two+ele_four)/ele_three;
//				int wyd2 = (ele_three*ele_two+ele_four)%ele_three;
//				answer.add(wyd1*10+wyd2);
    ...
    public void run() {
        ...
        while (!stopThread) {
            ...
            if ((!is_float) && (!is_middle)) {
                ...
                bundle.putBoolean("is_middle", false);
            ...
            if ((is_float) && (!is_middle)) {
                ...
                Log.e("76666666666666", problem1.get(count_float) + "");
                Log.e("99999999999999", problem1.get(count_float) + "");
                message.setData(bundle);
                handler_program.sendMessage(message);
                count_float++;
            }
