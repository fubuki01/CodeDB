...
import com.readboy.mentalcalculation.other.FAO;
	...
	public  void CreateSubject(){
		...
		switch (type) {
			case SEVENDIV://分数乘整数的计算方法
				...
				problem1.add(ele_two + ","+"/" +","+ ele_one + "," + "×" + "," + ele_three+ "," + "="+"乘");
			...
			case DIVWAY://分数除以整数的计算方法
				...
				problem1.add(ele_two+","+"/"+","+ele_one+","+"÷"+","+ele_three+","+"="+"除");
			...
			case MULANDADD://一个数除以分数的计算方法
				...
				problem1.add(ele_three+","+"÷"+","+ele_two+","+"/"+","+ele_one+","+"="+"整");
